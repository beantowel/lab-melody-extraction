import unittest
from utils.dataset import MedleyDB_Dataset, Adc2004_Dataset, RWC_Popular_Dataset, RWC_Royalty_Free_Dataset, Orchset_Dataset, MIREX_05_Dataset
from utils.dataset import MedleyDB_vocal_Dataset, MedleyDB_instrumental_Dataset, Adc2004_vocal_Dataset, Adc2004_instrumental_Dataset, MIREX_05_vocal_Dataset, MIREX_05_instrumental_Dataset
...
class EnumerateAllinDataset(unittest.TestCase):
    ...
    def test_RWC_Dataset(self):
        x = RWC_Popular_Dataset() + RWC_Royalty_Free_Dataset()
        self.enumerateTest(x)
    ...
    def test_MIREX_05_Dataset(self):
        for x in (MIREX_05_Dataset(), MIREX_05_vocal_Dataset(), MIREX_05_instrumental_Dataset()):
            self.enumerateTest(x)
